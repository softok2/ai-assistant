...
const suggestedActions = [
    {
        ...
        label: 'de golf del día',
        action: 'Muéstrame todas las reservas de golf programadas para hoy.',
    },
    {
        title: 'Revisar tee times',
        label: 'disponibles para mañana',
        action: 'Muéstrame los tee times disponibles para mañana en golf.',
    },
    {
